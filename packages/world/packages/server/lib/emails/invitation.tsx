...
export default function Invitation({
  organizationName = "An OpenKitten House",
  inviterName = "An OpenKitten member",
  url = websiteURL,
}: InvitationProps) {
  return (
    <Html>
      <Head />
      <Preview>
        {inviterName} invited you to join {organizationName} on OpenKitten
      </Preview>
      <Body style={main}>
          ...
          <Section style={card}>
            <div style={cardContent}>
              ...
              <Text style={subheading}>
                ...
                <strong>{organizationName}</strong> on OpenKitten.
              </Text>
