...
OpenKitten prompts for your Telegram bot token and user ID, then saves them to `~/.openkitten/profiles/<profile>/system/config/openkitten/telegram-auth.json`. To re-authenticate, delete the file and restart.
